...
public class Ex08_Printf_format {
	...
	public static void main(String[] args) {
		...
		System.out.printf("num의 값은 [%d] 입니다. 그리고 [%d]\n", num, 1000);
		
		float f = 3.14f;
		System.out.println(f);
		System.out.printf("f 변수 값은 : %f 입니다 \n", f);
		
		System.out.printf("문자열 값은 %s로 출력하고 %d 다음 숫자 출력","안녕으", 100);
		
		//cmd (console)에서 사용자가 입력한 값을 read 오기
		//java.util.Scanner sc = new java.util.Scanner(System.in);
		//위 코드처럼 클래스를 사용할라면 폴더 (package)를 열어 놓아야 합니다
		...
		//하지만 일단 nextLine(); 사용!! 오류있음
		//권장사항 : 그냥 문자로 read해서 필요하다면 형변환을 사용한다
		//TodayPoint 
		//☆★☆★[[[문자를 -> 숫자로]]]☆★☆★

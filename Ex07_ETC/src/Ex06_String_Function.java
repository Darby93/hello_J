...
public class Ex06_String_Function {
	public static void main(String[] args) {
		...
		System.out.println(filename.substring(0,11));
		//배열에 값이 없다 >> -1
		//return -1;
		...
		System.out.println(result.substring(0,1)); //endIndex - 1
		//The substring begins at the specified beginIndex 
		//and extends to the character at index endIndex - 1
		
		//Quiz
		String filename2 = "aaaaa.jjjp.g"; //파일명은 변경될 수 있다.
		//파일명  >>  홍길동
		//확장자  >>  jpg
	    ...
	    String re3 = jumin.replace("-", "");
	    String a1 = jumin.substring(0,6);
	    String a2 = jumin.substring(7);
	    
	    for(int i =0; i < re3.length(); i++) {
	    	sum += 	Integer.parseInt(re3.substring(i,i+1));
	    }
	    System.out.println(sum);

...
1. 상속
java > Child exends Base
c#   > Child : Base

2. 상속특징
-다중상속은 불가 (복잡성 ...)
-단일상속이 원칙 (계층적 상속을 사용해서 다중상속을 구현)
-다중상속을 지원 (유일하게 Interface만 되용!)
...
Memory 로딩 ... 모습 ... 누가 먼저 Memory 올라 갔을까
*/

class GrandFather{
	public int gmoney = 5000;
	private int pmoney = 50000; // private 가 있으면  상속관계에서 보이지 않는다 >> 자식들이 건들 수 없음
	                            // 참조변수도 접근 불가
	                            // 상속관계도 접근 불가
...
public class Ex01_Inherit {
	...
	public static void main(String[] args) {
		...
		//System.out.println(c.pmoney); //private 라  사용불가   거의 쓰지않을듯 ? 
